...
//	var v= new Array(6);
    ...
    var Tau=1;
		...
		//BDTCali BCRS;
		/*double *PB=new double[TL+1];
		double *PuB=new double[TL];
		double *PdB=new double[TL];
		double *rB=new double[TL+1];
		double *vB=new double[TL+1];
		double *CashFlow= new double[TL+1];
		double *CashFlowm1= new double[TL+1];*/
		var PB= new Array(6);
		var PuB= new Array(5);
		var PdB= new Array(5);
		var rB= new Array(6);
    ...
    document.isForm.price.value =FinalOptionPrice*N; 
...
function Reset(){
    ...
    document.isForm.Ts.value="4";
    document.isForm.X.value="0.062";
